        ...
        <div class="soft-panel small">
          ...
          <div class="soft-body compact">
            ...
            <input
              ...
              placeholder="Sierra Amazonia 2025-2026"
              maxlength="25"
            />
...
export class AnioLectivoAdminComponent implements OnInit {
  ...
  guardar(): void {
    ...
    // 🔹 Aquí añadimos "activo: true" para que el backend lo incluya en listar()
    const payload = {
  ...
  marcarComoActual(r: AnioLectivo): void {
    ...
    this.svc.setActual(r._id).subscribe({
      ...
      error: (e) => {
        ...
        this.toast.fire({
          icon: 'error',
          title: e?.error?.message || 'Error al marcar como actual',
        });
      },
    });
  }
